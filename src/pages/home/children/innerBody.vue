<template>
  <section class="wrap">
    <ul class="scroller">
      <li v-for="item in hot" class="item" :key="item.id">
        <section class="center">
          <h2 class="nm">{{item.nm}}<span :class="[
        ...
        <section class="right">
          <span class="grade"><span class="mark">{{item.preSale ? item.wish : item.mk}}</span>{{item.preSale ? '人想看' : '分'}}</span>
